...
const opcionesIniciales = ["Movilidad", "CORE", "Activación", "Fuerza tren inferior", "Fuerza tren superior"]
...
export default function TareasGimnasioPage() {
  ...
  useEffect(() => {
    const savedTasks = localStorage.getItem("tareas-gimnasio")
    if (savedTasks) {
      try {
  ...
  const handleGuardar = () => {
    ...
    localStorage.setItem("tareas-gimnasio", JSON.stringify(actualizado))
    ...
    <div className="min-h-screen bg-black text-gray-300 p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-yellow-400 text-center">Tareas de Gimnasio</h1>
        </div>
        <div className="w-20" />
      </div>
